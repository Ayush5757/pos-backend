...
const { save_new_order_inventorie_customer, save__order_to_existing_inventorie_customer, chanege_status_and_add_to_inventrie_to_table, get_new_order_inventorie_customer, otp_sender, delete_inventrie_to_table, save_new_order_inventorie_customer_without_OTP } = require('../controllers/roomorderinventorie');
...
router.route('/change/orderlocation/inventorie/delete').post(delete_inventrie_to_table);
router.route('/get/newOrder').get(get_new_order_inventorie_customer);
router.route('/otp/sender').post(otp_sender);
module.exports = {
    roomorderInventorieRoutes: router,
}
